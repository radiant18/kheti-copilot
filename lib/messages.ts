...
const TEMPLATES: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "water.t": "Your garden is {deficit} mm short of water",
    "water.w": "Over {days} days the sun and wind took {used} mm out of your soil and the rain put back {rain} mm. That is about {litres} litres per plant to make up.",
    "water.area.w": "Over {days} days the sun and wind took {used} mm out of your soil and the rain put back {rain} mm.",
    "water.ok.t": "No irrigation needed",
    "water.ok.w": "Over {days} days your crop used {used} mm and the rain gave {rain} mm. The soil is holding enough.",
    "water.wait.t": "Hold off — rain is coming",
    "water.wait.w": "You are {deficit} mm short, but {ahead} mm of rain is expected in the next two days. Watering today would be poured away.",
    "press.t": "{disease} pressure is building",
    "press.w": "{hours} wet hours in the band {disease} needs, against {threshold} where it takes hold. The longest unbroken wet spell was {run} hours. Symptoms show about a week after this, not now.",
    "press.ahead.w": "{hours} wet hours so far and {ahead} more coming in the next three days. {disease} takes hold near {threshold}.",
    "press.low.t": "{disease} pressure is low",
    "press.low.w": "Only {hours} wet hours in the band {disease} needs, against {threshold} where it takes hold.",
    "spray.t": "Spray {treatment} on {day}, {from} to {to}",
    "spray.w": "That is the only stretch this week with {hours} dry hours below 85% humidity — long enough for the spray to set.",
    "spray.rain.w": "That is the only stretch this week with {hours} dry hours below 85% humidity. Rain returns around {rain}, so finish before then.",
    ...
    "mkt.worth.t": "Your {crop} is worth ₹{net} today",
    "mkt.worth.w": "{qtl} quintals of {grade} grade at {market}'s ₹{price}/qtl{transport}. No other yard is far enough ahead to be worth the extra distance.",
    "mkt.worth.transport": ", less ₹{cost} to get it there",
    "mkt.best.t": "{crop} at ₹{price}/qtl",
    "mkt.best.w": "Best quote today is {market}, for {grade} grade. Add your unsold stock to get selling advice.",
  ...
  hi: {
    ...
    "water.t": "आपके बाग़ में {deficit} मिमी पानी की कमी है",
    "water.w": "{days} दिनों में धूप और हवा ने मिट्टी से {used} मिमी खींच लिया और बारिश ने {rain} मिमी लौटाया। भरपाई के लिए हर पौधे को लगभग {litres} लीटर चाहिए।",
    "water.area.w": "{days} दिनों में धूप और हवा ने मिट्टी से {used} मिमी खींच लिया और बारिश ने {rain} मिमी लौटाया।",
    "water.ok.t": "सिंचाई की ज़रूरत नहीं",
    "water.ok.w": "{days} दिनों में फ़सल ने {used} मिमी लिया और बारिश ने {rain} मिमी दिया। मिट्टी में पर्याप्त नमी है।",
    "water.wait.t": "रुकिए — बारिश आ रही है",
    "water.wait.w": "{deficit} मिमी की कमी है, पर अगले दो दिन में {ahead} मिमी बारिश की उम्मीद है। आज पानी देना बेकार जाएगा।",
    "press.t": "{disease} का दबाव बढ़ रहा है",
    "press.w": "{disease} जिस नमी में पनपता है, वैसे {hours} घंटे बीत चुके हैं; {threshold} पर यह जड़ पकड़ लेता है। सबसे लंबा लगातार गीला दौर {run} घंटे रहा। लक्षण अभी नहीं, करीब एक हफ़्ते बाद दिखेंगे।",
    "press.ahead.w": "अब तक {hours} गीले घंटे, और अगले तीन दिन में {ahead} और आएंगे। {disease} लगभग {threshold} पर पकड़ लेता है।",
    "press.low.t": "{disease} का दबाव कम है",
    "press.low.w": "{disease} जिस नमी में पनपता है, वैसे केवल {hours} घंटे हुए हैं; {threshold} पर यह पकड़ता है।",
    "spray.t": "{day} को {from} से {to} तक {treatment} छिड़कें",
    "spray.w": "इस हफ़्ते यही एक मौका है जब {hours} घंटे सूखे और 85% से कम नमी रहेगी — दवा जमने के लिए काफ़ी।",
    "spray.rain.w": "इस हफ़्ते यही एक मौका है जब {hours} घंटे सूखे रहेंगे। लगभग {rain} बजे बारिश लौटेगी, उससे पहले पूरा कर लें।",
    ...
    "mkt.worth.t": "आज आपकी {crop} की कीमत ₹{net} है",
    ...
    "mkt.best.t": "{crop} ₹{price}/क्विंटल",
    "mkt.best.w": "आज सबसे अच्छा भाव {market} में, {grade} किस्म का। अपना बचा हुआ माल जोड़ें तो बेचने की सलाह मिलेगी।",
  ...
  kn: {
    ...
    "water.t": "ನಿಮ್ಮ ತೋಟಕ್ಕೆ {deficit} ಮಿಮೀ ನೀರಿನ ಕೊರತೆ ಇದೆ",
    "water.w": "{days} ದಿನಗಳಲ್ಲಿ ಬಿಸಿಲು ಮತ್ತು ಗಾಳಿ ಮಣ್ಣಿನಿಂದ {used} ಮಿಮೀ ತೆಗೆದವು, ಮಳೆ {rain} ಮಿಮೀ ಮರಳಿಸಿತು. ಸರಿದೂಗಿಸಲು ಪ್ರತಿ ಗಿಡಕ್ಕೆ ಸುಮಾರು {litres} ಲೀಟರ್ ಬೇಕು.",
    "water.area.w": "{days} ದಿನಗಳಲ್ಲಿ ಬಿಸಿಲು ಮತ್ತು ಗಾಳಿ ಮಣ್ಣಿನಿಂದ {used} ಮಿಮೀ ತೆಗೆದವು, ಮಳೆ {rain} ಮಿಮೀ ಮರಳಿಸಿತು.",
    "water.ok.t": "ನೀರಾವರಿ ಅಗತ್ಯವಿಲ್ಲ",
    "water.ok.w": "{days} ದಿನಗಳಲ್ಲಿ ಬೆಳೆ {used} ಮಿಮೀ ಬಳಸಿತು, ಮಳೆ {rain} ಮಿಮೀ ಕೊಟ್ಟಿತು. ಮಣ್ಣಿನಲ್ಲಿ ಸಾಕಷ್ಟು ತೇವವಿದೆ.",
    "water.wait.t": "ತಡೆಯಿರಿ — ಮಳೆ ಬರುತ್ತಿದೆ",
    "water.wait.w": "{deficit} ಮಿಮೀ ಕೊರತೆ ಇದೆ, ಆದರೆ ಮುಂದಿನ ಎರಡು ದಿನಗಳಲ್ಲಿ {ahead} ಮಿಮೀ ಮಳೆ ನಿರೀಕ್ಷೆ. ಇಂದು ನೀರು ಕೊಟ್ಟರೆ ವ್ಯರ್ಥ.",
    "press.t": "{disease} ಒತ್ತಡ ಹೆಚ್ಚುತ್ತಿದೆ",
    "press.w": "{disease} ಬೆಳೆಯುವ ತೇವಾಂಶದಲ್ಲಿ {hours} ಗಂಟೆ ಕಳೆದಿವೆ; {threshold} ಗಂಟೆಗೆ ಅದು ಹಿಡಿಯುತ್ತದೆ. ಅತಿ ಉದ್ದದ ನಿರಂತರ ತೇವ {run} ಗಂಟೆ. ಲಕ್ಷಣಗಳು ಈಗಲ್ಲ, ಸುಮಾರು ವಾರದ ನಂತರ ಕಾಣುತ್ತವೆ.",
    "press.ahead.w": "ಇಲ್ಲಿಯವರೆಗೆ {hours} ತೇವ ಗಂಟೆಗಳು, ಮುಂದಿನ ಮೂರು ದಿನಗಳಲ್ಲಿ ಇನ್ನೂ {ahead}. {disease} ಸುಮಾರು {threshold} ಗಂಟೆಗೆ ಹಿಡಿಯುತ್ತದೆ.",
    "press.low.t": "{disease} ಒತ್ತಡ ಕಡಿಮೆ",
    "press.low.w": "{disease} ಬೆಳೆಯುವ ತೇವಾಂಶದಲ್ಲಿ ಕೇವಲ {hours} ಗಂಟೆ; {threshold} ಗಂಟೆಗೆ ಅದು ಹಿಡಿಯುತ್ತದೆ.",
    "spray.t": "{day} ರಂದು {from} ರಿಂದ {to} ವರೆಗೆ {treatment} ಸಿಂಪಡಿಸಿ",
    "spray.w": "ಈ ವಾರ {hours} ಗಂಟೆ ಒಣ ಮತ್ತು 85% ಕ್ಕಿಂತ ಕಡಿಮೆ ತೇವಾಂಶ ಇರುವ ಏಕೈಕ ಅವಧಿ ಇದು — ಔಷಧ ಕೂರಲು ಸಾಕು.",
    "spray.rain.w": "ಈ ವಾರ {hours} ಗಂಟೆ ಒಣ ಇರುವ ಏಕೈಕ ಅವಧಿ ಇದು. ಸುಮಾರು {rain} ಕ್ಕೆ ಮಳೆ ಮರಳುತ್ತದೆ, ಅದಕ್ಕೂ ಮೊದಲು ಮುಗಿಸಿ.",
    ...
    "mkt.worth.t": "ಇಂದು ನಿಮ್ಮ {crop} ಬೆಲೆ ₹{net}",
    ...
    "mkt.best.t": "{crop} ₹{price}/ಕ್ವಿಂಟಾಲ್",
    "mkt.best.w": "ಇಂದು ಅತ್ಯುತ್ತಮ ದರ {market} ನಲ್ಲಿ, {grade} ದರ್ಜೆಗೆ. ನಿಮ್ಮ ಉಳಿದ ದಾಸ್ತಾನು ಸೇರಿಸಿದರೆ ಮಾರಾಟದ ಸಲಹೆ ಸಿಗುತ್ತದೆ.",
  ...
  mr: {
    ...
    "water.t": "तुमच्या बागेत {deficit} मिमी पाण्याची कमतरता आहे",
    "water.w": "{days} दिवसांत ऊन आणि वाऱ्याने मातीतून {used} मिमी घेतले आणि पावसाने {rain} मिमी परत दिले. भरून काढण्यासाठी प्रत्येक झाडाला सुमारे {litres} लिटर लागेल.",
    "water.area.w": "{days} दिवसांत ऊन आणि वाऱ्याने मातीतून {used} मिमी घेतले आणि पावसाने {rain} मिमी परत दिले.",
    "water.ok.t": "पाणी देण्याची गरज नाही",
    "water.ok.w": "{days} दिवसांत पिकाने {used} मिमी वापरले आणि पावसाने {rain} मिमी दिले. मातीत पुरेसा ओलावा आहे.",
    "water.wait.t": "थांबा — पाऊस येतोय",
    "water.wait.w": "{deficit} मिमी कमी आहे, पण पुढील दोन दिवसांत {ahead} मिमी पावसाची शक्यता आहे. आज पाणी दिले तर वाया जाईल.",
    "press.t": "{disease} चा दाब वाढतोय",
    "press.w": "{disease} ज्या ओलाव्यात वाढतो तसे {hours} तास गेले आहेत; {threshold} तासांवर तो पकड घेतो. सर्वात मोठा सलग ओला काळ {run} तास होता. लक्षणे आता नाही, सुमारे आठवड्याने दिसतील.",
    "press.ahead.w": "आतापर्यंत {hours} ओले तास, आणि पुढील तीन दिवसांत आणखी {ahead}. {disease} सुमारे {threshold} वर पकड घेतो.",
    "press.low.t": "{disease} चा दाब कमी आहे",
    "press.low.w": "{disease} ज्या ओलाव्यात वाढतो तसे फक्त {hours} तास; {threshold} वर तो पकड घेतो.",
    "spray.t": "{day} रोजी {from} ते {to} या वेळेत {treatment} फवारा",
    "spray.w": "या आठवड्यात {hours} तास कोरडे आणि 85% पेक्षा कमी आर्द्रता असणारा हाच एकमेव काळ — औषध बसण्यास पुरेसा.",
    "spray.rain.w": "या आठवड्यात {hours} तास कोरडे असणारा हाच एकमेव काळ. सुमारे {rain} वाजता पाऊस परततो, त्याआधी संपवा.",
    ...
    "mkt.worth.t": "आज तुमच्या {crop} ची किंमत ₹{net} आहे",
    ...
    "mkt.best.t": "{crop} ₹{price}/क्विंटल",
    "mkt.best.w": "आज सर्वोत्तम भाव {market} मध्ये, {grade} प्रतीचा. तुमचा शिल्लक माल नोंदवा म्हणजे विक्रीचा सल्ला मिळेल.",
